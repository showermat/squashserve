...
faviconsrc = "https://upload.wikimedia.org/wikipedia/en/8/80/Wikipedia-logo-v2.svg";
rootdir = "wikipedia";
imgdir = "img";
oldimgdir = "img_old";
htmldir = "wiki";
...
useragent = "wikidump/0.2 contact:matthew.schauer.x@gmail.com (Please block temporarily and send email if bandwidth limit exceeded)"
...
# for page in ["Japan", "China", "Qinghai", "Hydronium", "Maxwell's equations", "Main Page"]: getpage(page);
# for page in []: getpage(page);
# exit(0);
...
""" % (datetime.date.today().strftime("%Y-%m-%d"), origin_root, origin_root, htmldir);
